          ...
          <div class="flex items-center justify-between">
            ...
            <div v-if="selectedTag" >
              <div class="flex items-center justify-start ">
                <div>
                  <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"></path></svg>
                </div>
                ...
                <button @click="selectedTag=''" class="text-green-500 hover:text-green-600 px-2 py-1">
            ...
            <div v-if="!selectedTag" class="flex justify-end">
              ...
              <div @click="sortAlphabetically" class="flex items-center cursor-pointer 
              px-1 py-1 rounded-lg hover:bg-gray-300 sm:ml-2">
                <div class="text-sm hidden sm:flex">
                  A-Z
                </div>
                <button class="flex flex-col items-center">
                  <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12"></path></svg>
                  <div class="text-xs flex sm:hidden">
                    A-Z
                  </div>
                </button>
              ...
              <div @click="sortTwitterFollowersCount" class="flex items-center cursor-pointer 
              px-1 py-1 rounded-lg hover:bg-gray-300 sm:ml-2">
                <div class="text-sm hidden sm:flex">
                  Followers
                </div>
                <button class="flex flex-col items-center">
                  <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4"></path></svg>
                  <div class="text-xs flex sm:hidden">
                    Followers
                  </div>
                </button>
